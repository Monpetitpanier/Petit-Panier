...
export default function ChargesFixes() {
  ...
  const { chargesFixes, ajouterChargeFixe } = useBudget();
  ...
  const total = totaliserMontants(chargesFixes);
  ...
  return (
    <SafeAreaView style={styles.container}>
      ...
      >
        ...
        <Text style={styles.titre}>Charges fixes</Text>

        <Text style={styles.sousTitre}>
          Loyer, abonnements, assurances... tout ce qui revient chaque mois.
        </Text>
        ...
        {chargesFixes.length === 0 ? (
          ...
          <View style={styles.carteVide}>
            ...
            <Text style={styles.texteVide}>
              Ajoutez votre loyer, vos abonnements ou vos assurances pour
              suivre votre budget mensuel.
            </Text>
          </View>
          ...
          chargesFixes.map((charge) => (
            <TouchableOpacity
              ...
              onPress={() =>
                navigation.navigate("DetailsChargeFixe", {
                  chargeId: charge.id,
                })
              }
            >
              ...
              <View style={styles.texteCharge}>
                ...
                {charge.jour && (
                  <Text style={styles.details}>
                    Prélevé le {charge.jour} du mois
                  </Text>
                )}
              </View>
